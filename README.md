...
Pre-market refresh can surface MTF alerts and enabled auto-trades use limit
entries with extended-session order support outside regular hours. The 10m 9 EMA
touch strategy does not alert or trade before 9:30 ET.
